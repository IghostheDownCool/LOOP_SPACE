...
.playlist-form-card .form-control::placeholder {
...
<div class="playlist-form-container">
    <div class="playlist-form-header">
        <h1><i class="bi bi-plus-circle" style="color: #1db954;"></i> Nova Playlist</h1>
        <p>Crie uma playlist para organizar suas músicas favoritas</p>
    </div>
        ...
        <form method="POST">
            ...
            <div class="form-actions">
                <button type="submit" class="btn-submit">
                    <i class="bi bi-check-circle"></i> Criar Playlist
                </button>
