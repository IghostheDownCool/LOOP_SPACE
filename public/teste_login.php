...
$email = 'admin@loopspace.com'; // ← Coloque o email que você usou no cadastro
$senha = '123456'; // ← Coloque a senha que você usou no cadastro

echo "<h2>🔍 Diagnóstico de Login</h2>";

$usuarioModel = new Usuario();

// 1. Testar buscarPorEmailLogin
...
if ($usuario) {
    ...
    if (password_verify($senha, $usuario['senha'])) {
        ...
        // 3. Teste alternativo: ver se o hash é válido
...
// 4. Verificar se o método buscarPorEmailLogin existe
...
try {
    ...
    if (empty($todos)) {
        ...
        echo "✅ " . count($todos) . " usuários encontrados:<br>";
